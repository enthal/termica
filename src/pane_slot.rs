...
pub struct PaneUiState {
    ...
    /// open. A reference overlay (no text input); Esc / click / another
    /// popup-open combo closes it. Mutually exclusive with the other
    /// popups — opening any one closes the rest.
