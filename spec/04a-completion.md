...
>
> The persistent-process model below remains the plan for **bash** and **zsh** (slices 4–5), whose extraction (`complete -p` / `_main_complete`) genuinely needs a warm, rc-loaded shell.
